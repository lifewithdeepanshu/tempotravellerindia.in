...
$title = $seater . " Seater Tempo Traveller on Rent in Delhi NCR";

// Dynamic Meta Tags
$metaTitle = $seater . " Seater Tempo Traveller on Rent in Delhi, Noida, Gurgaon, Ghaziabad & Faridabad";
$metaDescription = "Rent a " . $seater . " seater tempo traveller for family trips, corporate tours, wedding transportation and outstation travel in Delhi NCR. Luxury AC vehicles with experienced drivers.";
$metaKeywords = $seater . " seater tempo traveller, " . $seater . " seater tempo traveller on rent, " . $seater . " seater tempo traveller in delhi, noida, gurgaon, ghaziabad, faridabad";
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <section class="seater-hero">
        ...
        <div class="container">
            <div class="hero-content">
                ...
                <h1>
                    <span>9 Seater</span> Tempo Traveller on rent in <span>Delhi NCR</span>
                </h1>
